...
import com.example.demo.domain.UserUDT;
...
public class OrderController {
	...
	//@Autowired
	public OrderController(OrderRepository orderRepo,  OrderProps orderProps) { // DeliveryBoxRepository deliveryBoxRepo,
	...
	public String processOrder(@Valid Order order, Errors errors, SessionStatus sessionStatus
		...
		UserUDT userUDT = new UserUDT("percy", "Percy", "95451234");
